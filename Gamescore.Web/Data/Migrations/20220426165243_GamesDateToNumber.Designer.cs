...
namespace Gamescore.Web.Data.Migrations
{
    ...
    [Migration("20220426165243_GamesDateToNumber")]
    partial class GamesDateToNumber
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Gamescore.Entities.AppRole", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("AppUserGame", b =>
                {
                    b.HasOne("Gamescore.Entities.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Gamescore.Entities.FriendRequest", b =>
                {
                    b.HasOne("Gamescore.Entities.AppUser", "SentBy")
                        .WithMany("SentFriendRequests")
                        .HasForeignKey("SentById")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Gamescore.Entities.AppUser", "SentTo")
            ...
            modelBuilder.Entity("Gamescore.Entities.Player", b =>
                {
                    b.HasOne("Gamescore.Entities.AppUser", "Owner")
                        .WithMany("PlayersCreated")
                        .HasForeignKey("OwnerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Gamescore.Entities.AppUser", "UserPlayer")
                        .WithMany("Players")
            ...
            modelBuilder.Entity("Gamescore.Entities.Rating", b =>
                {
                    ...
                    b.HasOne("Gamescore.Entities.AppUser", "User")
                        .WithMany("GamesRated")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<System.Guid>", b =>
                {
                    b.HasOne("Gamescore.Entities.AppRole", null)
                        .WithMany()
